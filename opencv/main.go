...
//
//
//	go run -tags cgo opencv/main.go template.png
//	go run -tags cgo opencv/main.go template.png -min 0.75 -max 1.35 -steps 25 -thresh 0.72 -minscore 0.8
//	成功时在 stdout 输出缩进 JSON 数组（默认仅含 score>=0.8）；错误信息在 stderr。

//打包命令：.\opencv\package_go_opencv.ps1 -OpenCVBin "C:\opencv\build\install\x64\mingw\bin" -MingwBin "C:\msys64\mingw64\bin"
